...
export const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    body: [{ text: "元々使用していたデザインロゴ", href: "/works/misoka-logo" },"は比較的細い線を用いており、フライヤーやVJで使用される際に視覚的な主張に乏しいことが難点でした。\nそのため、元々のロゴにおいて基調となっていた縦・斜めのラインを強調し、太い線を用いることで視認性を高めることと、\nまた近年のDJロゴにて見かけるような、印象的なロゴ全体の形状を推すようなロゴデザインを参考に、可読性はある程度スポイルしつつも、ロゴ全体を塊感のあるものにすることを意識して制作しました。\nロゴのキーとなる部分は元のロゴにて印象的だった「s」の稲妻のようなラインで、その部分をメインに据えた上で他の文字を配置していきました。"],
    tags: ["design"],
    date: "2025-12-23",
  },
  {
